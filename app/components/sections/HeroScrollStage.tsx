...
export default function HeroScrollStage({ children }: { children: React.ReactNode }) {
  ...
  useGSAP(
    () => {
      ...
      // (The hero video is NOT scroll-scrubbed: it autoplays muted on a loop
      // while this stage zooms its [data-hero-bg] wrapper — the ambient scene
      // lives on its own clock. Only the venue video below is scrubbed.)
